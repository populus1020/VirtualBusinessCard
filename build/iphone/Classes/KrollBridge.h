...
@interface VirtualBusinessCardObject : KrollCoverageObject {
#else
@interface VirtualBusinessCardObject : KrollObject {
#endif
@private
...
extern NSString * VirtualBusinessCard$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	VirtualBusinessCardObject *_virtualbusinesscard;
    KrollObject* console;
	BOOL shutdown;
