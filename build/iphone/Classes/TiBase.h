...
// in simulator we redefine to format for VirtualBusinessCard Developer console
...
{\
	NSString * exceptionName = [@"org.virtualbusinesscard." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.virtualbusinesscard";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIVirtualBusinessCardNativeItemNone = -1, 
	UIVirtualBusinessCardNativeItemSpinner = -2,
	UIVirtualBusinessCardNativeItemProgressBar = -3,
	
	UIVirtualBusinessCardNativeItemSlider = -4,
	UIVirtualBusinessCardNativeItemSwitch = -5,
	UIVirtualBusinessCardNativeItemMultiButton = -6,
	UIVirtualBusinessCardNativeItemSegmented = -7,
	
	UIVirtualBusinessCardNativeItemTextView = -8,
	UIVirtualBusinessCardNativeItemTextField = -9,
	UIVirtualBusinessCardNativeItemSearchBar = -10,
	
	UIVirtualBusinessCardNativeItemPicker = -11,
	UIVirtualBusinessCardNativeItemDatePicker = -12,
	
	UIVirtualBusinessCardNativeItemInfoLight = -13,
	UIVirtualBusinessCardNativeItemInfoDark = -14,
	
	UIVirtualBusinessCardNativeItemDisclosure = -15,
	
	UIVirtualBusinessCardNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all VirtualBusinessCard instances of
