 ...
 * to send analytic data that can be viewed on the VirtualBusinessCard Dashboard.
 *
 * For information on getting started with VirtualBusinessCard Platform Services,
