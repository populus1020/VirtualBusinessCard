...
//@interface VirtualBusinessCardObject : NSObject
//@end

@interface VirtualBusinessCardObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[VirtualBusinessCardObject class]])
		{
			for (NSString *key in [[(VirtualBusinessCardObject*)o modules] allKeys])
			{
