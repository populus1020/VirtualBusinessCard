...
/**
 Base class for all VirtualBusinessCard views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the VirtualBusinessCard view hierarchy (such as wrapped iOS UIViews) was touched.
