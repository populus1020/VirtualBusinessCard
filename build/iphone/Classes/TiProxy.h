...
//Rare exceptions to indicate a bug in the _virtualbusinesscard code (Eg, function that a subclass should have implemented)
...
/**
 The base class for VirtualBusinessCard proxies.
 */
